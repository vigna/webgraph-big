...
public class EFGraph extends ImmutableGraph {
	...
	protected EFGraph(final CharSequence basename, final long n, final long m, final long upperBound, final int log2Quantum, final LongBigList graph, final LongBigList offsets) {
	...
	public static void store(final ImmutableGraph graph, final long upperBound, final CharSequence basename, final ProgressLogger pl) throws IOException {
	...
	public static void store(final ImmutableGraph graph, final long upperBound, final CharSequence basename, final int log2Quantum, final int cacheSize, final ByteOrder byteOrder, final ProgressLogger pl) throws IOException {
