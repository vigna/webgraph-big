...
public abstract class ArcLabelledImmutableGraph extends ImmutableGraph {
	 ...
	 *           labelled random-access method {@link #successors(long)}.
	 *
	...
	public ArcLabelledNodeIterator nodeIterator(final long from) {
		class InternalArcLabelledNodeIterator extends ArcLabelledNodeIterator {
			private long curr = from - 1;
			private final long n = numNodes();
			private final long hasNextLimit;

			public InternalArcLabelledNodeIterator(final long upperBound) {
	 ...
	 * valid data.
	 *
	 * @implSpec This implementation just unwrap the iterator returned by {@link #successors(long)} and
