/*
 * Copyright (C) 2003-2022 Paolo Boldi, Massimo Santini and Sebastiano Vigna
 *
...
public class Transform {
	 ...
	 *
	 * <p>
	 * This method creates a number of sorted batches on disk containing arcs represented by a pair of
	 * long integers in {@link java.io.DataInput} format ordered by target and returns an
	 * {@link ImmutableGraph} that can be accessed only using a {@link ImmutableGraph#nodeIterator()
	 * node iterator}. The node iterator merges on the fly the batches, providing a transposed graph.
	 * The files are marked with {@link File#deleteOnExit()}, so they should disappear when the JVM
	 * exits. An additional safety-net finaliser tries to delete the batches, too.
	 *
	 * <p>
