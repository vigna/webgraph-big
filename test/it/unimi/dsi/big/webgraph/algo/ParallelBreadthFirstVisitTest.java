...
public class ParallelBreadthFirstVisitTest {
	...
	public void testTree() {
		final ImmutableGraph graph = ImmutableGraph.wrap(ArrayListMutableGraph.newCompleteBinaryOuttree(10).immutableView());
	...
	public void testStar() {
		...
		final ParallelBreadthFirstVisit visit = new ParallelBreadthFirstVisit(ImmutableGraph.wrap(graph.immutableView()), 0, false, pl);
		final long componentSize = visit.visit(0);
