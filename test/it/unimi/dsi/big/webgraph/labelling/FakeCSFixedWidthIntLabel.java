...
public class FakeCSFixedWidthIntLabel extends AbstractIntLabel {
	...
	@Override
	public int fromBitStream(final InputBitStream inputBitStream, final long source) throws IOException, UnsupportedOperationException {
	...
	@Override
	public int toBitStream(final OutputBitStream outputBitStream, final long source) throws IOException, UnsupportedOperationException {
