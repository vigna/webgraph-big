	...
	public void testLarge() throws IOException {
		...
		for(final int log2m: new int[] { 4, 7 }) {
			...
			for(int attempt = 0; attempt < 10; attempt++) {
				final HyperBall hyperBall = new HyperBall(g, attempt % 3 == 0 ? ImmutableGraph.wrap(it.unimi.dsi.webgraph.Transform.transpose(ImmutableGraph.wrap(g))) : null, log2m, null, 0, 0, 0, attempt % 2 != 0, false, false, null, attempt);
